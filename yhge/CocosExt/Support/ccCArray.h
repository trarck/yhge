#ifndef YHGE_COCOSEXT_SUPPORT_CCARRAY_H_
#define YHGE_COCOSEXT_SUPPORT_CCARRAY_H_
...
/** 
 * 主要是因为cocos2d没有开放ccArray的dll导出接口，所以本地使用一份
 */

#ifndef CC_INVALID_INDEX
...
#endif // YHGE_COCOSEXT_SUPPORT_CCARRAY_H_
