...
void ISOTileLayerDynamicComponent::setucomponents(int iComponentNodeExtendCount)
{
...
void ISOTileLayerDynamicComponent::setucomponents(int iComponentNodeExtendCount,const Vec2& position)
{
	this->setComponentTileExtendCount(iComponentNodeExtendCount);
    this->calcComponentsCount();
    this->createComponents();
