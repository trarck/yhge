#ifndef YHGE_SMARTPOINTER_SMART_PTR2_H_
#define YHGE_SMARTPOINTER_SMART_PTR2_H_
...
template <class T, typename mem_mgr=StdMemMgr<T> >
...
template <typename T, typename mem_mgr=StdMemMgr<T> >
class MakeSharedPtr
{
public:
...
template <class T, typename mem_mgr=ArrayMemMgr<T> >
...
#endif // YHGE_SMARTPOINTER_SMART_PTR2_H_
